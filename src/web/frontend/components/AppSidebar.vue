<template>
  <nav class="sidebar">
    ...
    <ul class="nav-menu">
      ...
      <li><router-link to="/sessions" class="nav-link" :class="{ active: route.path === '/sessions' }">세션 관리</router-link></li>
      <li><router-link to="/tools" class="nav-link" :class="{ active: route.path === '/tools' }">연동 툴</router-link></li>
      <li><router-link to="/brain-memory" class="nav-link" :class="{ active: route.path === '/brain-memory' }">Brain 메모리</router-link></li>
